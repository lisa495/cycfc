...
@Configuration
@EnableSwagger2
public class ConsumerDemoSwagger2 {

    /**
     * 访问地址：http://localhost:8861/swagger-ui.html
     */
    @Bean
    public Docket createRestApi() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //设置包路径
                .apis(RequestHandlerSelectors.basePackage("com.cycfc.demo.consumer"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                //页面标题
                .title("标题：cycfc-demo-consumer 使用 Swagger2 构建 API 接口文档")
                //描述
                .description("描述：用于 cycfc-demo-consumer 接口查看")
